"""
src/AI/analyse_claude.py — MRJ3.0 Claude Vision Pipeline
...
def _phase_3_thesis(client, image_b64, image_mime) -> Dict[str, Any]:
    """Phase 3: Extract interior thesis."""
    system = core.get_phase_prompt(3)
    user   = (
        "Analyseer de interieurstijl van deze ruimte. "
        "Geef je antwoord als geldig JSON object:\n"
        '{"style": "...", "styleSummary": "...", "styleDescription": "...", '
        '"roomMood": "...", "luxuryLevel": "...", "warmthCoolness": "...", '
        '"materialLanguage": "...", "lineLanguage": "...", "spatialDensity": "..."}'
    )
    raw    = _call_claude_vision(client, system, image_b64, image_mime, user)
...
def run_analysis_pipeline(image_data_url: str) -> Dict[str, Any]:
    ...
    # ── PHASE 3: Interior thesis ───────────────────────────────
    thesis = _phase_3_thesis(client, image_b64, image_mime)
    ...
    result = {
        "qualityFailed":       False,
        "style":               thesis.get("style", ""),
        "styleSummary":        thesis.get("styleSummary", ""),
        "styleDescription":    thesis.get("styleDescription", ""),
        "roomMood":            thesis.get("roomMood", ""),
